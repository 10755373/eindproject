...
# Day 18
Vandaag ben ik voornamelijk bezig geweest met het opschonen van m'n code, het verhelpen van errors en het initialiseren en updaten van grafieken. Dit laatste is voor de scatterplot en linegraph gelukt, aangaande de worldmap heb ik nog niet bedacht hoe dit vorm gaat krijgen en de piechart neemt de juiste getallen mee maar vernieuwd somehow niet. Dit lijkt mij echter snel opgelost morgen. Daarnaast wil de 'linear gradient legend' maar niet verschijnen dus dit ga ik morgen regelen. Overigens zijn de linegraph en scatterplot voorzien van gridlines en de scatterplotcirkels van een kleurenpatroon. Overigens lukte het mij vandaag niet om de pagina onder te verdelen in twee evengrote kolommen die de volledige breedte van de pagina benutten (wel voor ongeveer 90%) en de labels van de lijngraph en scatterplot passen zich nog niet aan, dus dit staat voor morgen allemaal op de planning. Kortom; morgen wordt een dag van een heleboel ogenschijnlijk kleine, doch belangrijke problemen oplossen!
...
# Day 23
Vandaag was een goede dag! De tooltip voor de scatterplot en piechart/donut werken eindelijk aslmede de update voor de linegraph want deze werkte plotseling niet meer (dit kostte een hoop werk en zowel Jasper als Nigel hebben hier beiden ook een tijdlang zich erover gebogen). De code heb ik verder opgeschoond en een aantal functies binnen bootstrap verwerkt zoalsbijvoorbeeld een button waarmee een popup verschijnt wat extra informatie geeft over de linegraph en piechart/donut. Daarnaast zijn alle grafieken nu voorzien van een titel en labels welke zich aanpassen al naar gelang de optie die de gebruiker van de site wenst te zien. De pagina's zijn voorzien van extra informatie en dropdowns en de hover zijn beter gepositioneerd op de pagina. Voor mmorgen wil ik de code verder opschonen, mappen nog gestructureerder inrichten, meer informatie weergeven op de pagina's en de 'linear gradient color legend' beter positioneren aangezien deze op dit moment niet mooi op de pagina staat mijns inziens. Kortom; er staat voor de laatste dag nog genoeg op de planning, maar het framework staat in ieder geval!
